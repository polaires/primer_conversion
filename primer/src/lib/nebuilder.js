 ...
 */
export const OVERLAP_SCORING_WEIGHTS = {
 ...
 *
 * @param {string} seq - Overlap sequence to analyze
 * @param {Object} options - Analysis options
 * @returns {Object} Detailed analysis with scores
 */
export function analyzeOverlap(seq, options = {}) {
 ...
 *
 * @param {string} junction - Junction sequence (end of frag1 + start of frag2)
 * @param {Object} options - Optimization options
 * @returns {Object} Optimal overlap and alternatives
 */
export function optimizeOverlap(junction, options = {}) {
  const {
 ...
 *
 * @param {Array} fragments - Array of {id, seq} objects
 * @param {Object} options - Design options
 * @returns {Object} Complete assembly design
 */
 ...
 */
export function generateNEBuilderProtocol(fragmentCount) {
...
function scoreTmDeviation(tm, target, { optimal = 0, acceptable = 5, steep = 10 }) {
